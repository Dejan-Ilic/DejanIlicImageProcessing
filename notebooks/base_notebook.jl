...
# ╔═╡ c1d97675-9599-429f-873c-fd97c37ba1c6
begin
	using Revise
	using ImageFeatures, Images
	push!(LOAD_PATH, "C:/Users/dejan/.julia/dev/")
...
# ╔═╡ 82d05cdf-9165-4568-b2b6-d06f443c02c9
md"*Oocyte constants*"

# ╔═╡ 3cd7bb40-c541-11ec-37a6-f17e530b0486
begin
	const OOCYTE_FOLDER = "C:\\Users\\dejan\\OneDrive - Vrije Universiteit Brussel\\Oocytes\\Datasets\\raw"; #change this
	const OOCYTE_LIST = readdir(OOCYTE_FOLDER);
end;

# ╔═╡ 2e3ff204-03eb-448c-a487-86f0782760f9
md"*Typical imports*"

# ╔═╡ 476c5b04-1457-4ada-bf79-ccf55136a33f
md"### end start-up

------------------------------------------
"

# ╔═╡ 73876c43-7090-44cd-b566-b54c4c85103f
md"#### Test oocyte import"

# ╔═╡ 0b35224a-7da1-4ac2-b3bd-b4748147ed36
stack1 = read_oocyte_stack(321, OOCYTE_FOLDER, OOCYTE_LIST);

# ╔═╡ b82910a7-2df4-480b-ac83-d61e1787b8a1
md"#### Test base fusion"

# ╔═╡ c5268c6a-3b5d-4011-af93-1af37e7dfae7
bfusion1 = base_fusion(stack1);

# ╔═╡ f3f5c4d7-d0e2-4097-8bc1-e5ab6da3a9f3
imshow(bfusion1)

# ╔═╡ 7dc64430-59e7-4df7-9f27-e64711f0c735
md"#### Test guided filter"

# ╔═╡ 79c0243f-88ab-4a4a-b7ca-f6679fbd36bc
let c = testimage("cameraman") .|> gray .|> Float64
	hcat(Gray.(c), naive_guided_filter(c,c,2,1e-2) .|> Gray,)
end

# ╔═╡ 997fbe57-b18e-4de8-94b5-d972bc668020
md"#### Test guided fusion"

# ╔═╡ d4a115b8-424b-4a80-9883-31cc47fff8d2
gfusion1 = guided_fusion(stack1);

# ╔═╡ a345ad25-dae7-40db-97e3-98e2f7eb26c1
imshow(gfusion1)
